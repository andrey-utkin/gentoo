...
if [[ $PV == 9999 ]]; then
	...
	# Obviously because upstream has not committed to supporting random point
	# of git history.
	# Repoman complains about "live VCS" ebuild being keyworded at all.
	# TODO Maintain tarballs to make repoman happy.
else
